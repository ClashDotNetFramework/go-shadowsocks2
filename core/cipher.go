...
var streamList = map[string]struct {
	...
	"AES-128-CFB8":      {16, shadowstream.AESCFB8},
	"AES-192-CFB8":      {24, shadowstream.AESCFB8},
	"AES-256-CFB8":      {32, shadowstream.AESCFB8},
	"AES-128-OFB":       {16, shadowstream.AESOFB},
	"AES-192-OFB":       {24, shadowstream.AESOFB},
	"AES-256-OFB":       {32, shadowstream.AESOFB},
	"BF-CFB":            {16, shadowstream.BFCFB},
	"CAST5-CFB":         {16, shadowstream.CAST5CFB},
	"DES-CFB":           {8,  shadowstream.DESCFB},
	"IDEA-CFB":          {16, shadowstream.IDEACFB},
	"RC2-CFB":           {16, shadowstream.RC2CFB},
	"SEED-CFB":          {16, shadowstream.SEEDCFB},
	"CAMELLIA-128-CFB":  {16, shadowstream.CamelliaCFB},
	"CAMELLIA-192-CFB":  {24, shadowstream.CamelliaCFB},
	"CAMELLIA-256-CFB":  {32, shadowstream.CamelliaCFB},
	"CAMELLIA-128-CFB8": {16, shadowstream.CamelliaCFB8},
	"CAMELLIA-192-CFB8": {24, shadowstream.CamelliaCFB8},
	"CAMELLIA-256-CFB8": {32, shadowstream.CamelliaCFB8},
